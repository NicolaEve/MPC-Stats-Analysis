...
z.paired(rand_10fff_rm_flat_in$FlatInBT, rand_10fff_rm_flat_in$FlatInAT)
z.paired(rand_10fff_rm_flat_cross$FlatCrossBT, rand_10fff_rm_flat_cross$FlatCrossAT)
```
...
true negs/pos will be logged somewhere? not loads so could do manually
