...
for (n in 1:length(testingdf)){
  ...
  # plot values
  colours = c("Actual Values" = "red", "Control Limits" = "yellow", "1 Step Prediction" = "blue", "5 Step Prediction" = "green")
  print(ggplot(arima_df, aes(x = Date)) +
  geom_line(aes(y = actual_val, color = "Actual Values"), size = 1.2) +
  geom_line(aes(y = one_step, color = "1 Step Prediction"), size = 1.2) +
  geom_line(aes(y = lcl, color = "Control Limits"), size = 1.2) +
  geom_line(aes(y = ucl, color = "Control Limits"), size = 1.2) +
  geom_line(aes(y = five_step, color = "5 Step Prediction"), size = 1.2) +
    labs(title = energy,
         x = "Date",
         y = colname,
         color = "legend") +
...
last_date = df6x$QA_Date[nrow(df6x)]
...
ggplot(tail(df6x, n=15)) +
  geom_line(aes(x = QA_Date, y = Uniformity), color = "blue") +
  geom_point(aes(x = next_day, y = pred$mean), color = "red") +
  geom_point(aes(x = next_day, y = pred_5$mean[1]), color = "yellow") +
  geom_point(aes(x = next_2, y = pred_5$mean[2]), color = "yellow") +
geom_point(aes(x = next_3, y = pred_5$mean[3]), color = "yellow") +
  geom_point(aes(x = next_4, y = pred_5$mean[4]), color = "yellow")+
  geom_point(aes(x = next_5, y = pred_5$mean[5]), color = "yellow")
```
