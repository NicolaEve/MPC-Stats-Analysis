...
#sum(df6x$uniformity_test == "pass")
sum(df6x$symm_test == "pass") / sum(df6x$uniformity_test == "pass")
...
#sum(recent6x$uniformity_test == "pass")
sum(recent6x$symm_test == "pass") / sum(recent6x$uniformity_test == "pass")
```
