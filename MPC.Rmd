...
# remove outliers so we can build a predictive model
# this removes everything
cols = c("Uniformity", "Output_Change", "MPC_Distance")
df6x_rm_out <- remove_outliers(df6x, c("Uniformity", "Output_Change", "MPC_Distance"))
df10x_rm_out <- remove_outliers(df10x, cols)
df10fff_rm_out <- remove_outliers(df10fff, cols)

#plot_mpc_time(df6x_rm_out, "6x")
#plot_mpc_time(df10x_rm_out, "10x")
#plot_mpc_time(df10fff_rm_out, "10xFFF")
```
