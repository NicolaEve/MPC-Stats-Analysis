...
sensitvity and specificty functions
...
```
Function to add pass/fail columns to the dataframes
...
boxplot(rand_10fff_rm_flat_in$FlatInAT, rand_10fff_rm_flat_in$FlatInBT)
z.paired(rand_10fff_rm_flat_in$FlatInAT, rand_10fff_rm_flat_in$FlatInBT, 0, alpha = 0.05)

boxplot(rand_10fff_rm_flat_cross$FlatCrossAT, rand_10fff_rm_flat_cross$FlatCrossBT)
z.paired(rand_10fff_rm_flat_cross$FlatCrossAT, rand_10fff_rm_flat_cross$FlatCrossBT, 0, alpha = 0.05)
...
plot_mpc_time <- function(df, energy){
  ...
  geom_point() +
    geom_smooth(aes(x = QA_Date, y = Output_Change), method = "loess") +
  xlab("QA Date") +
  ylab("Output Change") +
