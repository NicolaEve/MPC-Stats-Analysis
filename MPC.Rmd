...
Comparing the symmetry and flatness to Uniformity
...
```{r}
ratio <- df6x$SymmInAT / df6x$Uniformity
mean(ratio)
...
```{r}
boxplot(df6x$SymmInAT, df6x$SymmCrossAT, df6x$Uniformity)
boxplot(recent6x$SymmInAT, recent6x$SymmCrossAT, recent6x$Uniformity)
boxplot(rand_df$SymmInAT, rand_df$SymmCrossAT, rand_df$Uniformity)
```

taking random sample from the recent df
```{r}
rand_recent6x <- recent6x[sample(nrow(recent6x), size=50), ]

z.paired(rand_recent6x$SymmInAT, rand_recent6x$SymmCrossAT, 0, alpha = 0.05)
boxplot(rand_recent6x$SymmInAT, rand_recent6x$SymmCrossAT, rand_recent6x$Uniformity)

#z.paired(rand_recent6x$MPC_Distance, rand_recent6x$Calibrated_Distance, 0, alpha = 0.05)
#boxplot(rand_recent6x$Calibrated_Distance, rand_recent6x$MPC_Distance)

z.paired(rand_recent6x$FlatInAT, rand_recent6x$FlatCrossAT)
boxplot(rand_recent6x$FlatInAT, rand_recent6x$FlatCrossAT)

z.paired(rand_recent6x$SymmInBT, rand_recent6x$SymmInAT)
z.paired(rand_recent6x$SymmCrossBT, rand_recent6x$SymmCrossAT)
z.paired(rand_recent6x$FlatCrossBT, rand_recent6x$FlatCrossAT)
z.paired(rand_recent6x$FlatInBT, rand_recent6x$FlatInAT)

rand_recent6x$uniformity_test <- "fail"
rand_recent6x$uniformity_test[rand_recent6x$Uniformity<2 & rand_recent6x$Uniformity>-2] <- "pass"

rand_recent6x$symm_test <- "fail"
rand_recent6x$symm_test[rand_recent6x$SymmInAT<2 & rand_recent6x$SymmInAT>-2 & rand_recent6x$SymmCrossAT<2 & rand_recent6x$SymmCrossAT>-2] <- "pass"

false_pos <- sum(rand_recent6x$uniformity_test == "pass" & rand_recent6x$symm_test == "fail")
true_pos <- sum(rand_recent6x$uniformity_test == "pass" & rand_recent6x$symm_test == "pass")
false_neg <- sum(rand_recent6x$uniformity_test == "fail" & rand_recent6x$symm_test == "pass")
true_neg <- sum(rand_recent6x$uniformity_test == "fail" & rand_recent6x$symm_test == "fail")

sens <- true_pos / (true_pos + false_neg)
print("sensitivy when taking the max symm")
print(sens)

spec <- true_neg / (true_neg + false_pos)
print("specifity when taking the max symm")
print(spec)

rand_recent6x$symm_in_test <- "fail"
rand_recent6x$symm_in_test[rand_recent6x$SymmInAT<2 & rand_recent6x$SymmInAT>-2] <- "pass"

false_pos <- sum(rand_recent6x$uniformity_test == "pass" & rand_recent6x$symm_in_test == "fail")
true_pos <- sum(rand_recent6x$uniformity_test == "pass" & rand_recent6x$symm_in_test == "pass")
false_neg <- sum(rand_recent6x$uniformity_test == "fail" & rand_recent6x$symm_in_test == "pass")
true_neg <- sum(rand_recent6x$uniformity_test == "fail" & rand_recent6x$symm_in_test == "fail")
...
rand_recent6x$symm_cross_test <- "fail"
rand_recent6x$symm_cross_test[rand_recent6x$SymmCrossAT<2 & rand_recent6x$SymmCrossAT>-2] <- "pass"

false_pos <- sum(rand_recent6x$uniformity_test == "pass" & rand_recent6x$symm_cross_test == "fail")
true_pos <- sum(rand_recent6x$uniformity_test == "pass" & rand_recent6x$symm_cross_test == "pass")
false_neg <- sum(rand_recent6x$uniformity_test == "fail" & rand_recent6x$symm_cross_test == "pass")
true_neg <- sum(rand_recent6x$uniformity_test == "fail" & rand_recent6x$symm_cross_test == "fail")
...
fit3 <- lm(SymmInAT ~ poly(SymmCrossAT , 4, raw=TRUE), recent6x)  
summary(fit3)

cor.test(rand_recent6x$SymmCrossAT, rand_recent6x$SymmInAT)

cor.test(rand_recent6x$Uniformity, rand_recent6x$SymmInAT)
cor.test(rand_recent6x$Uniformity, rand_recent6x$SymmCrossAT)

cor.test(rand_recent6x$FlatInAT, rand_recent6x$FlatCrossAT)
cor.test(rand_recent6x$Uniformity, rand_recent6x$FlatCrossAT)
cor.test(rand_recent6x$Uniformity, rand_recent6x$FlatInAT)

ggplot(recent6x, aes(x = FlatInAT, y = FlatCrossAT)) +
